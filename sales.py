...
class salesClass:
    def __init__(self,root):
        ...
        #________________Variable___________
        self.bill_list=[]
        self.var_invoice=StringVar()

        #__________________title_____________
        ...
        #_______________________Bill List_________________
        ...
        #_______________________Bill Area______________________
        ...
        #_________________________Image________________________
        ...
        #________________________________________Function_________________
    def show(self):
        del self.bill_list[:]
