...
class BillClass:
    def __init__(self,root):
        ...
        #________Product_Frame_________
        ...
        #_______________________Product Search Frame____________________
        ...
        #_______________________Product Detail Frame____________________
        ...
        #___________________________Customer Frame__________________
        ...
        #_______________________Cal Cart Frame____________________
        Cal_Cart_Frame=Frame(self.root,bd=4,relief=RIDGE,bg="white")
        Cal_Cart_Frame.place(x=420,y=190,width=530,height=360)

        #_______________________Calculator Frame____________________
        ...
        #_______________________Cart Frame____________________
        ...
        #_______________________ADD Cart Widgets Frame____________________
        ...
        btn_clear_cart=Button(Add_CartWidgetsFrame,text="Clear",font=("times new roman",15,"bold"),bg="lightgray",cursor="hand2",command=self.clear_cart).place(x=180,y=70,width=150,height=30)
        ...
        #________________________Billing area______________
        ...
        #_______________________Billing buttons____________________
        ...
        #__________________Footer_________________________
...
#_________________________________All Functions_______________________________________
    ...
    def add_update_cart(self):
        if self.var_pid.get()=='':
            ...
            #________________________Update_Cart___________________________
            present='no'
            index_=0
    ...
    def bill_middle(self):
        ...
        try:
            for row in self.cart_list:
                ...
                #____________Update qty in product table_____________________
