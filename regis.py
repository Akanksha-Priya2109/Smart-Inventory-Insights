...
class employeeClass:
    def __init__(self,root):
        ...
        #_________All Variables_________
        ...
        btn_search=Button(SearchFrame,text="Search",command=self.search,font=("goudy old style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=415,y=9,width=150,height=29)
        ...
        #_________row1_____________
        lbl_emp=Label(self.root,text="Emp ID",font=("goudy old style",15),bg="white").place(x=50,y=150)
        ...
        #__________row2________________
        lbl_name=Label(self.root,text="Name",font=("goudy old style",15),bg="white").place(x=50,y=190)
        lbl_dob=Label(self.root,text="D.0.B",font=("goudy old style",15),bg="white").place(x=350,y=190)
        ...
        #__________row3________________
        ...
        #__________row4________________
        ...
        #__________Employee Details_____________
