...
class Login_System:
    def __init__(self,root):
        self.root=root
        self.root.title("Login System | Developed By Akanksha Priya")
        self.root.geometry("1350x700+0+0")
        self.root.config(bg="#fafafa")

        self.otp=StringVar()
        #_____________________images_________________
        self.phone_image=ImageTk.PhotoImage(file="images/phone.png")
        self.lbl_phone_image=Label(self.root,image=self.phone_image,bd=0).place(x=200,y=50)

        #__________________Login_Frame_________________
        ...
        btn_forget=Button(login_frame,text="Forget Password",command=self.forget_window,font=("times new roman",13),bg="white",fg="#00759E",cursor="hand2",bd=0,activebackground="white",activeforeground="#00759E").place(x=100,y=390)

        #__________________Frame 2_________________
        ...
        # btn_signup=Button(register_frame,text="Sign up",font=("times new roman",13,"bold"),bg="white",fg="#00759E",cursor="hand2",bd=0,activebackground="white",activeforeground="#00759E").place(x=200,y=17)
        lbl_reg=Label(register_frame,text="Inventory Management System",font=("times new roman",13,"bold"),bg="white").place(x=0,y=20,relwidth=1)
    
        #__________________________Animation Images____________
...
#________________________________All Function_____________________________________
        ...
        try:
            if self.employee_id.get()=="":
                ...
                if email==None:
                    ...
                    #_________________Forget Window______________
    ...
    def send_email(self,to_):
        ...
        msg=f'Dear Sir/Madam,\n\nYour Reset OTP is {str(self.top)}.\n\nWith Regards,\nIMS Team'
        msg="Subject:{}\n\n{}".format(subj,msg)
