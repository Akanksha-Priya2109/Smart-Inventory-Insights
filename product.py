...
class productClass:
    def __init__(self,root):
        ...
        #______________________Variables____________
        ...
        #____________________________Frame______________
        product_Frame=Frame(self.root,bd=2,relief=RIDGE,bg="white")
        product_Frame.place(x=10,y=10,width=450,height=480)

        #____________________________title____________
        title=Label(product_Frame,text="Manage Product Details",font=("goudy old style",18),bg="#0f4d7d",fg="white").pack(side=TOP,fill=X)

        #__________________________Col1__________________
        ...
        #_________Col2______________________________________
